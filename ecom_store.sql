...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2020 at 12:30 PM
...
(1, 'About Us - Our Story', 'It is our attempt to make a website for the Food Lovers to satisfy their Food Cravings in the period of COVID-19 Lockdown. DIY recipes at our website and food ingredients being delivered at your doorstep.', 'Frippery is a prototype shopping kart website with the sole purpose of motivating individuals to utilising the lockdown time by going do it yourself(DIY) mode during the lockdown period. The website provides a huge database of dishes with the ingredients and recipe already embedded in the database. When user adds any dish to the kart, all the ingredients involved with the dish is added to the   kart and the recipe is sent at the email address of the user. Currently we are focussing on dishes and later might expand our boundaries to other produt.The product can be extremely useful for such pandemics and can be a great alternative for amazon pantry as the products doesn’t have to be added individually.');
