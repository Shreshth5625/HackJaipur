            ...
            <div class="contact-box">
                <div class="contact-area">
                    <div class="contact-header">
                        <h4 class="header-text"> FRIPPERY</h4>
                        <p class="mb-0">Please enter the issue with your contact info below </p>
                    </div>
                    <div class="contact-body">
                        <form method="post" id="contact-form" autocomplete="off">
                            ...
                            <div class="contact-field">
                                <div class="success-msg"> Thank You very much for contacting us.FRIPPERY will look for a solution ASAP. </div>
                            </div>    
                            <div class="contact-field">
        ...
        $('#contact-form').validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    ...
                    type : 'POST',
                    url : 'php/php-contact.php',                    data : $('#contact-form').serialize(),
                    beforeSend : function(){
                        $('#loader').show();
                        $('#submit').hide();
                    },
